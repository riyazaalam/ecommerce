...
<head>
    ...
    <title>Login Page - Rupam Precision Engineering</title>
                                                ...
                                                <div class="row m-0">
                                                    ...
                                                    <div class="col-lg-6 col-12 px-4 py-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="email" name="email" id="email" value="{{old('email',$request->email)}}" class="form-control mb-3" placeholder="Username">
                                                        </div>
                                                       <div>
                                                            <label for="password">Password</label>
                                                            <input type="password" name="password" id="password"  value="{{old('password')}}" class="form-control mb-2" placeholder="Enter Password">
                                                       </div>
                                                        <div>
                                                            <label for="confirm_password">Confirm Password</label>
                                                            <input type="password" name="password_confirmation" id="password"  value="{{old('password')}}" class="form-control mb-2" placeholder=" Enter Confirm Password">
                                                        </div>
